...
//   return (
//     <div className="bg-gradient-to-br from-[#1e1e36] to-[#2d2b63] text-white min-h-screen p-6">
...
//           <button className="px-4 py-2 bg-[#272639] text-white mr-1 rounded-t-md">Event Details</button>
//           <button className="px-4 py-2 bg-[#9c3797] text-white mr-1 rounded-t-md">Assign Coordinator/Coordinator</button>
//           <button className="px-4 py-2 bg-[#272639] text-white mr-1 rounded-t-md">Session Management</button>
//           <button className="px-4 py-2 bg-[#272639] text-white mr-1 rounded-t-md">Generate SOW</button>
//         </div>
...
//               <div className="border border-gray-600 rounded p-2 mb-2 flex justify-between">
