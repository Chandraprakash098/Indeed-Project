...
//   return (
//     <div className="bg-[#241e3a] p-5 h-full text-white flex flex-col">
//       {/* Logo */}
...
//                 <li className="py-1">
//                   <Link to="/event-requests" className="text-gray-300 hover:text-purple-300 flex items-center">
//                     <div className="w-2 h-2 bg-purple-400 rounded-full mr-2"></div>
//                     <span>New Requests</span>
//                   </Link>
//                 </li>
//                 <li className="py-1">
//                   <Link to="#" className="text-gray-300 hover:text-purple-300 flex items-center">
//                     <div className="w-2 h-2 bg-purple-400 rounded-full mr-2"></div>
//                     <span>Estimate</span>
//                   </Link>
//                 </li>
...
//           {/* Other menu items */}
//           <li className="py-2">
//             <Link to="#" className="text-white hover:text-purple-300">Positions</Link>
//           </li>
//           <li className="py-2">
//             <Link to="#" className="text-white hover:text-purple-300">Contractors</Link>
//           </li>
...
//           <li className="py-2">
//             <Link to="#" className="text-white hover:text-purple-300">Profile</Link>
//           </li>
//         </ul>
//       </nav>
...
//         <button className="w-full bg-[#22233b] text-white py-2 rounded-md hover:bg-[#2d2e50] transition-colors flex items-center justify-center">
